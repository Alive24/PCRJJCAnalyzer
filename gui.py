...
class Ui_PCRJJCAnalyzerGUI(object):
    def setupUi(self, PCRJJCAnalyzerGUI):
        ...
        self.manualSetChar.setGeometry(QtCore.QRect(320, 30, 91, 23))
        ...
        self.queryStatusTag.setGeometry(QtCore.QRect(690, 70, 121, 20))
        ...
        self.recognizeAndSolveButton_TeamTwoFromHisotry.setGeometry(QtCore.QRect(120, 60, 91, 23))
        ...
        self.recognizeAndSolveButton_TeamThreeFromHisotry.setGeometry(QtCore.QRect(220, 60, 91, 23))
        ...
        self.recognizeAndSolveButton_OwnTeam.setGeometry(QtCore.QRect(320, 60, 91, 23))
    ...
    def retranslateUi(self, PCRJJCAnalyzerGUI):
        ...
        self.char1Label.setText(_translate("PCRJJCAnalyzerGUI", "角色1"))
        self.char2Label.setText(_translate("PCRJJCAnalyzerGUI", "角色2"))
        self.char3Label.setText(_translate("PCRJJCAnalyzerGUI", "角色3"))
        self.char4Label.setText(_translate("PCRJJCAnalyzerGUI", "角色4"))
        self.char5Label.setText(_translate("PCRJJCAnalyzerGUI", "角色5"))
